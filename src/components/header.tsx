    ...
    >
      <nav className="container mx-auto flex h-16 items-center justify-between px-4">
                  ...
                  {navigation.map((item) => (
                    <li key={item.name}>
                      <Link
                        ...
                        className={cn(
                          "block py-2 text-lg",
                          location.pathname === item.href ? "font-medium" : "text-gray-600",
                        )}
                      >
                        {item.name}
                      </Link>
        ...
        <div className="flex-1 lg:flex-none">
          <Link to="/" className="text-xl font-bold text-center lg:text-left block lg:inline">
            NOCTAEL
          </Link>
        </div>
              ...
              <li key={item.name}>
                <Link
                  ...
                  className={cn(
                    ...
                    location.pathname === item.href ? "text-black" : "text-gray-600",
                  )}
                >
                  {item.name}
                </Link>
